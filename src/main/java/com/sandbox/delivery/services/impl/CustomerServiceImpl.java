...
public class CustomerServiceImpl implements CustomerService {
	...
	public List<CustomerBO> getAllCustomer() {
		return CustomerMapper.INSTANCE.listCustomerToListCustomerBO((List<Customer>) customerRepository.findAll());
	}

	public CustomerBO getByCustomerNumber(String customerNumber) {
		return CustomerMapper.INSTANCE.customerToCustomerBO(customerRepository.findByCustomerNumber(customerNumber));
	}
